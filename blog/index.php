...
?>
    ...
    <div class="container-meu mt-3">
        ...
        <br>
        <h2>Política, filosofia, história, reflexões, resenhas e opiniões você encontra aqui</h2>
        <br>
    ...
    <main class="container-meu">
        ...
        <h2>Precisa de ajuda com Filosofia, História e Sociologia para o Enem?</h2>
        <p>Se preparar para o Enem/Vestibular é uma tarefa complicada, especialmente se preparar para as matérias que não temos facilidade. No meu caso, os bichos papões são química e física, mas felizmente possuo alguns pontos fortes, portanto me disponho a te ajudar com as matérias que eu tenho facilidade e que já estudei até o momento, que são filosofia, história e sociologia. Se precisar de ajuda com essas matérias entre em contato acessando a aba <a href="contato.php">Contato.</a> Ficarei feliz em ajudar.</p>
