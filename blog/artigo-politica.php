...
include 'php-artigo-politica.php'
...
<html>
    ...
    <body>
        ...
        <main class="container-meu label1"> 
                ...
                <br>
                <h1>Nazismo & Comunismo: Gêmeos do terror (argumentos de comparação)</h1>
                <br><br>
                <img class="img-fluid imgcentro" src="img/teste2.jpg" alt="imagem chamativa">
                <br><br><br>

                <?php foreach ($artigo as $artigo): ?>
                    <h3>
                        <?php echo $artigo['subtitulo'] ?>
                    </h3>
                    <p>
